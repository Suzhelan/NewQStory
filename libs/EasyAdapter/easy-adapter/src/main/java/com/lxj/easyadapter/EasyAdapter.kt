...
abstract class EasyAdapter<T>(data: List<T>, protected var mLayoutId: Int) :
    MultiItemTypeAdapter<T>(data) {
    ...
    protected open fun bindWithPayloads(
        holder: ViewHolder,
        t: T,
        position: Int,
        payloads: List<Any>
